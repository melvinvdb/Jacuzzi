...
bool RADIO::init(const bool switchOn) {
  return(false);
} // init()
...
void RADIO::setBassBoost(const bool switchOn) {
  _bassBoost = switchOn;
} // setBassBoost()
...
/// The base implementation ony stores the value to the internal variable.
void RADIO::setMono(const bool switchOn) {
  _mono = switchOn;
} // setMono()
...
/// The base implementation ony stores the value to the internal variable.
void RADIO::setMute(const bool switchOn) {
  _mute = switchOn;
} // setMute()
...
/// The base implementation ony stores the value to the internal variable.
void RADIO::setSoftMute(const bool switchOn) {
  _softMute = switchOn;
} // setSoftMute()
...
void RADIO::setBand(const RADIO_BAND newBand) {
  _band = newBand;
...
void RADIO::seekUp(const bool)   {}
void RADIO::seekDown(const bool) {}
...
bool RADIO::checkRDS(uint16_t* block1, uint16_t* block2, uint16_t* block3, uint16_t* block4) {
