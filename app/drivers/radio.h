...
public:
  ...
  virtual bool   init(const bool switchOn);  ///< initialize library and the chip.
  ...
  virtual void    setMute(const bool switchOn);       ///< Control the mute mode of the radio chip.
  virtual bool    getMute();                    ///< Retrieve the current mute mode setting.

  virtual void    setSoftMute(const bool switchOn);   ///< Control the softmute mode (mute on low signals) of the radio chip.
  virtual bool    getSoftMute();                ///< Retrieve the current soft mute mode setting.

  virtual void    setBassBoost(const bool switchOn);  ///< Control the bass boost mode of the radio chip.
  ...
  virtual void       setBand(const RADIO_BAND newBand);   ///< Set the current band.
  ...
  virtual void       seekUp(const bool search = true);   ///< Start a seek upwards from the current frequency.
  virtual void       seekDown(const bool search = true); ///< Start a seek downwards from the current frequency.

  virtual void       setMono(const bool switchOn);   ///< Control the mono mode of the radio chip.
  ...
  virtual bool checkRDS(uint16_t* block1, uint16_t* block2, uint16_t* block3, uint16_t* block4); ///< Check if RDS Data is available and good.
