...
public:
  ...
  typedef CallBack <RDSParserInterrupt, void, char *> RdsReceiveServiceNameCallback;
  typedef CallBack <RDSParserInterrupt, void, char *> RdsReceiveTextCallback;
  typedef CallBack <RDSParserInterrupt, void, uint8_t, uint8_t> RdsReceiveTimeCallback;
  ...
  /*void attachServicenNameCallback(receiveSRDSParserInterruptervicenNameFunction newFunction); ///< Register function for displaying a new Service Name.
  ...
  void registerForCallback(RDSParserInterrupt& classCallBack);
...
private:
  ...
  RdsReceiveServiceNameCallback callBackServiceName;
  RdsReceiveTextCallback callBackText;
  RdsReceiveTimeCallback callBackTime;
